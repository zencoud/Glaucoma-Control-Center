            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <img class="h-8 w-auto" src="{{ asset('img/glaucoma-control-center-logo.png') }}" alt="Logo">
                    </div>
                    <div class="ml-4">
            ...
            <div class="p-4">
                <nav class="space-y-2">
                    <a href="{{ route('admin.gallery.index') }}" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.gallery.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100' }}">
